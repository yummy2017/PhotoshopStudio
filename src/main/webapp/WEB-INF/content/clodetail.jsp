 ...
 <div class="row">
  ...
  <div class="container-fluid tile">
   ...
   <div class="row">
    <div class="col-lg-12  text-center">
      <h2> ${sessionScope.cloth.clothes}<a name="cloth"></a></h2>
    </div>
    </div>
   </div>
  
  <div class="container-fluid">
    <form method="get" action="clothdetail" id="clothesForm"> 
    <c:forEach items="${requestScope.cloth_list }" var="cloth">
  <div class="row">
  ...
  <div class="carousel-inner" role="listbox ppp">
    ...
    <div class="item active">
      ...
      <img src=${cloth.img} alt="..."  class="img-responsive" >
      <div class="carousel-caption">
         活动一
      </div>
    </div>
    <div class="item">
      <img src=${cloth.img1} alt="..."  class="img-responsive" >
      <div class="carousel-caption">
        活动二
      </div>
    </div>
    <div class="item">
      <img src=${cloth.img2} alt="..." class="img-responsive">
      <div class="carousel-caption">
        活动三
      </div>
    </div>
    <div class="item">
      <img src=${cloth.img3} alt="..." class="img-responsive">
      <div class="carousel-caption">
        活动三
      </div>
    </div>
    <div class="item">
      <img src=${cloth.img4} alt="..." class="img-responsive">
      <div class="carousel-caption">
        活动四
      </div>
    </div>
  ...
  <div class="panel-heading"><h2>${cloth.clothes}</h2></div>
  

  <!-- List group -->
  <ul class="list-group">
    <li class="list-group-item">价格：${cloth.price}</li>
  </ul>
  <div class="panel-body">
    <p>描述：${cloth.description}</p>
  </div>
</div>
