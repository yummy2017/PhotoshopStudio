  ...
  <div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-12  text-center">
      <h2> 相册<a name="picture"></a></h2>
    </div>
    </div>
   </div>
   
   <div class="container-fluid">
   <form method="get" action="album" id="albumForm"> 
   <div class="container-fluid"></div>
	<div class="fixaut"><p>&nbsp;</p></div>
	<div class="fixautcenter">
		<div class="row">
		<c:forEach items="${requestScope.album_list }" var="album">
      	<div class="col-lg-4 col-sm-4 col-md-4"><img class="img-responsive" src=${album.img}></div>
		 </c:forEach>
      </div>
	</div>
	<div class="fixaut"><p>&nbsp;</p></div>
