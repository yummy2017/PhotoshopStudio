...
<div class="container">
 ...
 <div class="row">
  <div class="container-fluid">
   ...
   <div class="container-fluid">
   <div class="row">
    <div class="col-lg-9  col-sm-12 col-md-12 text-center fiximg">
      <img src="images/1.jpg" class="img-responsive "  alt="Responsive image">
    </div>
    <div class="col-lg-3  col-sm-12 col-md-12 text-center fiximg">
      <div class="row">
      	<div class="col-lg-12 "><img class="img-responsive" src="images/2.jpg"></div>
      </div>
      <div class="row">
      	<div class="col-lg-12 "><img class="img-responsive" src="images/3.jpg"></div>
      </div>
      <div class="row">
      	<div class="col-lg-12 "><img class="img-responsive" src="images/4.jpg"></div>
      </div>
    </div>
    </div>
	   </div>
