  ...
  <div class="container-fluid tile">
   <div class="row">
    <div class="col-lg-12  text-center">
      <h2> 服装<a name="cloth"></a></h2>
    </div>
    </div>
   </div>
  
  <div class="container-fluid">
  <form method="get" action="cloth" id="clothesForm"> 
  <div class="row">
  <c:forEach items="${requestScope.cloth_list }" var="cloth">
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src=${cloth.img} alt=${cloth.clothes}>
      <div class="caption">
        <h3>${cloth.clothes}</h3>
        <p>${cloth.description}</p>
        <p><a href="clothdetail.html.action?clothes=${cloth.clothes}" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
      </div>
    </div>
  </div>
  </c:forEach>
